...
프로젝트 목표	- 커뮤니티 서비스 구축 (모임 생성·참여 및 사용자 간 소통 기능 구현)
...
GitHub	moitreport/moit-v3 at main · LimChaeyeon0629/moitreport

시연 영상	MOIT 3차 기능 Report

배포 주소	moitreport.duckdns.org

주요기능	■ 주요 기능 & 담당 업무 - 사용자 신고 및 관리자 처리 기능 담당
...
사용자 신고 작성 화면	내 신고 상세 화면
 	 
관리자 신고 목록 화면	관리자 신고 상세 화면
...
AFTER_COMMIT + @Async 코드	비동기 이메일 전송 1분 주기 스케줄러
...
유사 사례 검색 + 유사도 계산 + 원문 조회	임베딩 API + RAG 참고 문서 + GPT 호출
...
관리자 처리 + 신뢰도 변화 + Audit Log	3년 주기 장기 누적 데이터 관리
