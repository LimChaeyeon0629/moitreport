...
기간 / 인원	2026.07.02 ~ 2026.07.14 (6명)
개발환경
및 언어	Java 17, Spring Boot, Spring Security, OAuth2, MyBatis, Oracle, Thymeleaf,
HTML5, CSS3, JavaScript, OpenAI GPT API, SMTP, Git, GitHub, Notion
GitHub	moitreport/moit-v2 at main · LimChaeyeon0629/moitreport

시연 영상	MOIT 2차 기능 Report - YouTube
...
OpenAI 기반 신고 사유 자동 생성	관리자 신고 처리 상태 + 신뢰도 점수
 	 
관리자 신고 처리 상태 + 신뢰도 점수	신고 처리 결과 메일 자동 발송
