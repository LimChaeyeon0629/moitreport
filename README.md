...
3. `모임 찾기`에서 신고할 모임글을 선택합니다.
4. 모임 상세 화면에서 `신고하기`를 누릅니다.
5. 신고 사유를 작성하고 신고를 등록합니다.

### 2. 사용자 신고 내역 확인

1. 일반회원으로 로그인합니다.
2. `마이페이지 → 신고 목록`으로 이동합니다.
3. 등록한 신고의 접수 번호, 신고 대상, 처리 상태를 확인합니다.
...
3. 관리자 신고 관리 페이지에서 접수된 신고 목록을 확인합니다.
4. 신고 상세 화면에서 내용을 확인한 후 승인 또는 반려할 수 있습니다.
